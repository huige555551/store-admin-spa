    ...
    <el-dialog title="添加管理员" v-model="formDialog">
      <el-form :model="newAdmin" label-width="100px">
        ...
        <el-form-item label="重复密码">
          <el-input v-model="newAdmin.rePassword"></el-input>
        </el-form-item>
        <el-form-item label="角色">
          <el-select v-model="newAdmin.role">
            <el-option label="超级管理员">超级管理员</el-option>
            <el-option label="平台管理员">平台管理员</el-option>
            <el-option label="普通管理员">普通管理员</el-option>
          </el-select>
        </el-form-item>
