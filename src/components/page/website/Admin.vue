     ...
     <el-table-column prop="lastLoginTime" label="上次登陆事件" width="200"></el-table-column>
      ...
      <el-table-column label="操作" min-width="160">
        <template scope="scope">
          <el-button size="small" @click.native.prevent="previewDialog = true">编辑</el-button>
  ...
  data() {
    return {
      ...
      tableData: [{
        name: 'admin',
        role: '超级管理员',
        email: 'http://www.gedi.com',
        lastLoginTime: '2017-05-21 21:49:17'
      }
      ]
    }
  },
